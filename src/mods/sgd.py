...
class SGD(MOD):
    ...
    def __init__(self):
        ...
        self.bgiName = "/SGD_1.0.0.4/SGD.1.0.0.4_basicGeneInformation.json"
        self.diseaseName = "/SGD_1.0.0.4/SGD_1.0.0.4_disease.daf.json"
        self.phenotypeName = "/SGD_1.0.0.4/SGD_1.0.0.4_phenotype.json"
        self.alleleName = ""
