...
class Human(MOD):
    ...
    def __init__(self):
        ...
        self.bgiName = "/RGD_1.0.1_basicGeneInformation.9606.json"
        self.diseaseName = "/RGD_1.0.1_disease.9606.daf.json"
        self.geneAssociationFile = "/GO/ANNOT/gene_association.human.gz"
