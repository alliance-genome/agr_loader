...
class ExonETL(ETL):
    ...
    exon_query_template = """
            ...
            LOAD CSV WITH HEADERS FROM \'file:///%s\' AS row
                ...
                MATCH (t:Transcript {gff3ID: row.parentId})
    ...
    genomic_locations_template = """
        ...
        LOAD CSV WITH HEADERS FROM \'file:///%s\' AS row
            ...
            MATCH (o:Exon {primaryKey: row.curie})
    ...
    def _process_sub_type(self, sub_type):
        ...
        query_list = [
            [ExonETL.exon_query_template, commit_size,
             "exon_data_" + sub_type.get_data_provider() + ".csv"],
            [ExonETL.chromosomes_template, commit_size,
             "transcript_data_chromosome_" + sub_type.get_data_provider() + ".csv"],
            [ExonETL.genomic_locations_template, commit_size,
