...
class GeoXrefETL(ETL):
    ...
    def _load_and_process_data(self):
        ...
        for sub_type in self.data_type_config.get_sub_type_objects():
            ...
            query_list = [
                [GeoXrefETL.geo_xref_query, commit_size, "geoxref_data_" + sub_type.get_data_provider() + ".csv"],
            ]
    ...
    def get_generators(self, batch_size, species_encoded):
        ...
        for record in return_set:
            ...
            geo_xref = ETLHelper.get_xref_dict(global_cross_ref_id.split(":")[1],
                                               ...
                                               "gene/other_expression",
                                               "GEO",
                                               "https://www.ncbi.nlm.nih.gov/sites/entrez?Db=geoprofiles&DbFrom=gene&Cmd=Link&LinkName=gene_geoprofiles&LinkReadableName=GEO%20Profiles&IdsFromResult="+global_cross_ref_id.split(":")[1],
