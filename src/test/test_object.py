...
class TestObject(object):
    ...
    testOntologyTerms = {'DOID:0110741', 'DOID:0110739', 'DOID:10021', 'DOID:10030', 'DOID:0001816',
    ...
    modMap = {"RGD": rgdTestSet,
              "MGI": mgiIdSet,
              "ZFIN": zfinIdSet,
              "WB": wormbaseIdSet,
              "SGD": wormbaseIdSet,
              "FlyBase": flybaseIdSet,
              "Human": humanTestSet}
    ...
    def __init__(self, useTestObject, modList):
        ...
        #self.assemble_test_data(modList, self.modMap)

    def assemble_test_data(self, modList):
